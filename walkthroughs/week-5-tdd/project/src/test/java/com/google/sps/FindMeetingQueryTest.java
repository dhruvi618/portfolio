...
public final class FindMeetingQueryTest {
  ...
  public void optionsForNoAttendees() {
    ...
    assertThat(query.query(NO_EVENTS, request)).containsExactly(TimeRange.WHOLE_DAY);
  }
  ...
  public void ignoresPeopleNotAttending() {
    ...
    assertThat(query.query(events, request)).containsExactly(TimeRange.WHOLE_DAY);
  }
  ...
  @Test
  public void optionalAttendeeDoesNotAffectMeetingOptions() {
    // Have each person have different events with attendee C being optional.
    // We should still return the same three options that would have been returned orginally.
    //
    // Optional : |--------------C--------------|
    // Events  :        |--A--|     |--B--|
    // Day     :  |-----------------------------|
  ...
  @Test
  public void optionalAttendeeAffectsMeetingOptions() {
    // Have each person have different events with attendee C being optional.
    // We should return two options (early and late in the day) which would accomodate for C to attend.
    //
    // Optional :             |--C--|
    // Events  :        |--A--|     |--B--|
    // Day     :  |-----------------------------|
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    ...
    // at one point in the day to have the meeting (disregard optional attendee).
    //
    // Optional :       |-B-|
    // Events   : |--A--|     |----A----|
    // Day      : |---------------------|
  ...
  public void everyOptionalAttendeeIsConsidered() {
    // Have each optional attendee have different events with gaps in their days.
  ...
  @Test
  public void optionalAttendeesWithOverlappingEvents() {
    // Have an event for each person, but their events overlap without gap. We should see no options.
    //
    // Optional : |-----A-----|
    //                      |-----B-----|
    // Day      : |---------------------|
